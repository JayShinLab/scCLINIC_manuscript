...
markers<-FindMarkers(obj,ident.1 ="Ori", ident.2 = "DEAlgo",
                     min.cells.group = 0,
                     min.cells.feature = 0,
                     min.pct = 0,
                     logfc.threshold = 0,
...
saveRDS(markers,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_Ori_DEAlgo_Stroma.rds"))

markers<-FindMarkers(obj,ident.1 ="Ori", ident.2 = "DF",
                     min.cells.group = 0,
                     min.cells.feature = 0,
                     min.pct = 0,
                     logfc.threshold = 0,
                     ...
                     only.pos = FALSE,
                     features = genes.filter)  ##Output and rank all filtered genes
saveRDS(markers,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_Ori_DF_Stroma.rds"))

markers<-FindMarkers(obj,ident.1 ="DF", ident.2 = "DEAlgo",
                     min.cells.group = 0,
                     min.cells.feature = 0,
                     min.pct = 0,
                     logfc.threshold = 0,
                     ...
                     only.pos = FALSE,
                     features = genes.filter)  ##Output and rank all filtered genes
saveRDS(markers,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_DF_DEAlgo_Stroma.rds"))

  
#CELL TYPE SPECIFIC GSEA
markersDEAlgo <- readRDS(paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_Ori_DEAlgo_Stroma.rds"))
markersDF <- readRDS(paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_Ori_DF_Stroma.rds"))
markersOri <- readRDS(paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_DF_DEAlgo_Stroma.rds"))
...
saveRDS(Hlst,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/","GSEA_Result_",dbused,"_","Stroma",".rds"))
