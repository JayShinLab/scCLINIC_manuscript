...
Idents(obj)="CT.Park"
markers<-FindMarkers(obj,ident.1 ="Prox.Tubule",
                     min.cells.group = 0,
                     min.cells.feature = 0,
                     min.pct = 0,
                     logfc.threshold = 0,
...
saveRDS(markers,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_Ori_ProxTubule.rds"))
...
markers<-FindMarkers(obj,ident.1 ="Prox.Tubule",
                     ...
                     only.pos = FALSE,
                     features = genes.filter)  ##Output and rank all filtered genes
saveRDS(markers,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_DE_ProxTubule.rds"))
...
markers<-FindMarkers(obj,ident.1 ="Prox.Tubule",
                     ...
                     only.pos = FALSE,
                     features = genes.filter)  ##Output and rank all filtered genes
saveRDS(markers,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_DF_ProxTubule.rds"))



#CELL TYPE SPECIFIC GSEA
markersDEAlgo <- readRDS(paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_DE_ProxTubule.rds"))
markersDF <- readRDS(paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_DF_ProxTubule.rds"))
markersOri <- readRDS(paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/GSEA_Marker_Ori_ProxTubule.rds"))
...
saveRDS(Hlst,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig3/","GSEA_Result_",dbused,"_","ProxTubule",".rds"))
