cell_type = commandArgs(trailingOnly=TRUE) #"M6" B Cells "M3"
...
saveRDS(markers,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/GSEA_Marker_Ori_Healthy_",cell_type,".rds"))
...
markers<-FindMarkers(obj,ident.1 =cell_type,
                     ...
                     only.pos = FALSE,
                     features = genes.filter)  ##Output and rank all filtered genes
saveRDS(markers,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/GSEA_Marker_DE_Healthy_",cell_type,".rds"))
...
markers<-FindMarkers(obj,ident.1 =cell_type,
                     ...
                     only.pos = FALSE,
                     features = genes.filter)  ##Output and rank all filtered genes
saveRDS(markers,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/GSEA_Marker_DF_Healthy_",cell_type,".rds"))


#
dbused <- "Hgmt"
#CELL TYPE SPECIFIC GSEA
markersDEAlgo <- readRDS(paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/GSEA_Marker_DE_Healthy_",cell_type,".rds"))
markersDF <- readRDS(paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/GSEA_Marker_DF_Healthy_",cell_type,".rds"))
markersOri <- readRDS(paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/GSEA_Marker_Ori_Healthy_",cell_type,".rds"))
...
write.table(as.matrix(H),file = paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/Healthy_Ori_FGSEA_",dbused,"_",cell_type,".csv"),sep = ",")
...
rank<-setNames(markerssub$stat,rownames(markerssub))
H<-fgsea(Hgmt,rank,eps= 0.0,nproc=1,nPermSimple = 100000)
write.table(as.matrix(H),file = paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/Healthy_DFQC_FGSEA_",dbused,"_",cell_type,".csv"),sep = ",")
...
rank<-setNames(markerssub$stat,rownames(markerssub))
H<-fgsea(Hgmt,rank,eps= 0.0,nproc=1,nPermSimple = 100000)
write.table(as.matrix(H),file = paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/Healthy_DEAlgo_FGSEA_",dbused,"_",cell_type,".csv"),sep = ",")

Hlst <- c(DEAlgoResult=H,Hlst)

saveRDS(Hlst,paste0("~/DEAlgoManuscript/Manuscript_Figures/Fig5/Healthy_Result_",dbused,"_",cell_type,".rds"))
